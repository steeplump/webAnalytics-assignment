...
We will use the [NRC lexicon](https://saifmohammad.com/WebPages/NRC-Emotion-Lexicon.htm) to get sentiments from the reviews. The NRC lexicon helps categorise the text by classifying words and their associations with eight basic emotions (anger, fear, anticipation, trust, surprise, sadness, joy, and disgust) and two sentiments (negative and positive).
...
To better visualise the data, we can 
